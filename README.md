...
4. **Pencatatan Waktu Kerja (`TimeEntry`)**: Melacak durasi pengerjaan tugas untuk penagihan klien (*client billing*), analisis beban kerja, dan perencanaan sumber daya.
5. **Keamanan & Tata Kelola (RBAC & Audit)**: Pengaturan hak akses bertingkat (*Role-Based Access Control*) di level Organisasi, Workspace, dan Proyek, didukung pencatatan `AuditLog` penuh.
