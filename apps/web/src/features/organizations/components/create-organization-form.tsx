      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="flex flex-col gap-y-1.5">
          <div className="flex items-center justify-between">
            ...
            <AiMagicButton 
              type="suggest-task"
              inputValue={`Organization name: ${watch('name')}`}
              onResult={(res) => {
          ...
          <Textarea
            ...
            className="w-full border-zinc-800 bg-zinc-950 px-3 py-2 text-zinc-100 placeholder:text-zinc-600 focus-visible:ring-1 focus-visible:ring-orange-500 focus-visible:border-orange-500 focus-visible:outline-none transition-all resize-none"
